...
RetroMachine="Sony - PlayStation"
TargetCore="${core_swanstation}"
TargetCoreName="${core_swanstation_name}"
TargetRomDir="${SonyPSX}"
TargetLplFile="${PlaylistsDir}/${RetroMachine}.lpl"

echo "$RetroMachine"
check_if_rom_dir_exists "${TargetRomDir}"
lpl_build_header > "${TargetLplFile}"
generate_sonyplaystation_image_list_from "${TargetRomDir}"
