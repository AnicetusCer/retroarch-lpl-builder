...
RetroMachine="SNK - Neo Geo Pocket Color"
TargetCore="${core_race}"
TargetCoreName="${core_race_name}"
TargetRomDir="${SNKNGPC}"
TargetLplFile="${PlaylistsDir}/${RetroMachine}.lpl"

lpl_build_header > "${TargetLplFile}"
generate_snkngpc_image_list_from ${TargetRomDir}
