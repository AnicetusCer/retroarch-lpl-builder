...
RetroMachine="Atari - Jaguar"
TargetCore="${core_virtualjaguar}"
TargetCoreName="${core_virtualjaguar_name}"
TargetRomDir="${AtariJaguar}"
TargetLplFile="${PlaylistsDir}/${RetroMachine}.lpl"

lpl_build_header > "${TargetLplFile}"
generate_atarijaguar_image_list_from ${TargetRomDir}
