...
RetroMachine="Nintendo - Game Boy Advance"
TargetCore="${core_mgba}"
TargetCoreName="${core_mgba_name}"
TargetRomDir="${NintendoGBA}"
TargetLplFile="${PlaylistsDir}/${RetroMachine}.lpl"

lpl_build_header > "${TargetLplFile}"
generate_nintendogba_image_list_from "${TargetRomDir}"
