...
RetroMachine="Nintendo - Nintendo Entertainment System"
TargetCore="${core_nestopia}"
TargetCoreName="${core_nestopia_name}"
TargetRomDir="${NintendoNES}"
TargetLplFile="${PlaylistsDir}/${RetroMachine}.lpl"

echo "$RetroMachine"
check_if_rom_dir_exists "${TargetRomDir}"
lpl_build_header > "${TargetLplFile}"
generate_nintendones_image_list_from "${TargetRomDir}"
