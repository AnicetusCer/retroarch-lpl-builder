...
RetroMachine="NEC - PC Engine SuperGrafx"
TargetCore="${core_mednafen_pce}"
TargetCoreName="${core_mednafen_pce_name}"
TargetRomDir="${NECPCEngine}"
TargetLplFile="${PlaylistsDir}/${RetroMachine}.lpl"

lpl_build_header > "${TargetLplFile}"
generate_necpcenginercdsupergrafx_image_list_from "${TargetRomDir}"
